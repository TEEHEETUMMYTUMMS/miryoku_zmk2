...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &u_out_tog,        U_NU,              &kp C_VOL_UP,      U_NU,              &kp C_BRI_UP,      \
&kp LALT,          &kp LGUI,          &kp LCTRL,         &kp U,             U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        &kp C_BRI_DEC,     \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp PRCNT,         &kp N7,            &kp N8,            &kp N9,            &kp PLUS,          \
&kp LALT,          &kp LGUI,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp ASTRK,         &kp N4,            &kp N5,            &kp N6,            &kp MINUS,         \
U_NA,              &kp RALT,          &u_to_U_NAV,       &u_to_U_NUM,       U_NA,              &kp DLLR,          &kp N1,            &kp N2,            &kp N3,            &kp EQUAL,         \
...
U_NA,              &kp RALT,          &u_to_U_MEDIA,     &u_to_U_FUN,       PAUSE_BREAK,       &kp K_APP,         &kp F1,            &kp F2,            &kp F3,            &kp F10,           \
