...
U_NA,              &kp RALT,          &u_to_U_NAV,       &u_to_U_NUM,       PIPE,              &kp SEMI,          &kp N1,            &kp N2,            &kp N3,            &kp BSLH,          \
...
U_NA,              &kp RALT,          &u_to_U_MOUSE,     &u_to_U_SYM,       GRAVE,             &kp COLON,         &kp PLUS,          &kp LBKT,          &kp LBRC,          &kp HASH,          \
